...
$CMAKE "$CMAKE_OPTS" $CMAKE_UTESTS -DHDF5_USE_GNU_DIRS=OFF -DBUILD_STATIC_LIBS=OFF -DHDF5_ALLOW_UNSUPPORTED=ON -DHDF5_BUILD_JAVA=ON -DHDF5_BUILD_TOOLS=ON -DHDF5_ENABLE_THREADSAFE=ON \
